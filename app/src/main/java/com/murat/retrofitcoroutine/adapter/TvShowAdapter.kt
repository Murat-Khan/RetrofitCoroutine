package com.murat.retrofitcoroutine.adapter
...
import coil.load
import com.murat.retrofitcoroutine.databinding.TvShowItemBinding
...
class TvShowAdapter: RecyclerView.Adapter<TvShowAdapter.MyViewHolder>() {
    inner class MyViewHolder( val binding : TvShowItemBinding) : RecyclerView.ViewHolder(binding.root)
        ...
        private val differ = AsyncListDiffer(this@TvShowAdapter,diffCallback)
